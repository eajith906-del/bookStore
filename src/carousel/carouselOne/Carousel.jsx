...
const Carousel = () => {
  ...
  // shared cart + quick view (same instance Bookstore uses)
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // only show live, non-deleted products in the carousel
  ...
  const getStep = () => {
    ...
    // one card width + one gap = exactly one book moves per click
